...
public class Lector {
	 ...
	 * @param ruta donde se encuentra el archivo .json
	 */
	public static boolean comprobarInconsistencias() {
		...
		try {
			...
			for(Object aux: coordenadas) {
				...
				//Este for itera del 0 al tamao del array de vecinos
				for(int i=0; i<vecinos.size();i++) {

					//Segun el nmero en el que este iterando el for entra en un case u otro, para comprobar primero si la celda es un borde o si no lo es
	 ...
	 * @param ruta donde se encuentra el archivo .json
	 */
	public static void realizarLectura() {
